var $ = require("jquery");
// 定义一个分页方法，可多次调用
module.exports = function paginationNick(opt,obj,callback){
//    参数设置
    var pager={
...
//              内容区填充数据
    ...
    function createOtherBtn(){
        $('.'+pager.paginationBox).html('<div class="'+pager.btnBox+'"><button data-page="first" class="first-btn">'+pager.firstBtnText+'</button><button data-page="prev" class="prev-btn">'+pager.prevBtnText+'</button><span class="'+pager.numBtnBox+'"></span><button data-page="next" class="next-btn">'+pager.nextBtnText+'</button><input type="text" placeholder="请输入页码" class="'+pager.ipt+'"><button class="'+pager.goBtn+'">'+pager.confirmText+'</button><button data-page="last" class="last-btn">'+pager.lastBtnText+'</button></div><div class="'+pager.mainBox+'"></div>');
